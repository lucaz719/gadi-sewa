...
const coupons = [
  ...
  { id: 2, title: 'Free Car Wash', desc: 'Complimentary wash with any repair > NPR 2000.', code: 'WASHFREE', valid: '15 Dec 2024', bg: 'from-blue-500 to-indigo-500' },
  { id: 3, title: 'NPR 500 Off', desc: 'Flat discount on invoice above NPR 5000.', code: 'FLAT500', valid: '31 Dec 2024', bg: 'from-purple-500 to-pink-500' },
];
    ...
    <div className="space-y-8">
       ...
       <div className="bg-white dark:bg-[#1e293b] rounded-2xl border border-slate-200 dark:border-slate-700 p-8 shadow-sm text-center relative overflow-hidden">
           <div className="relative z-10">
               ...
               <p className="text-slate-500 max-w-md mx-auto mb-6">Earn 1 point for every NPR 100 spent. Redeem points for exclusive discounts on services and parts.</p>
       ...
       <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
           ...
           <div className="flex flex-col md:flex-row items-center gap-6">
               <div className="flex-1">
                   <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">Invite your friends to GadiSewa. They get <span className="font-bold text-slate-900 dark:text-white">NPR 200 off</span> their first service, and you get <span className="font-bold text-slate-900 dark:text-white">100 points</span>!</p>
