      ...
      <div className="bg-white dark:bg-[#1e293b] w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-bold text-slate-500 uppercase mb-1">Buy Price (NPR )</label>
              <input
                type="number" required
            ...
            <div>
              <label className="block text-sm font-bold text-slate-500 uppercase mb-1">Sell Price (NPR )</label>
              <input
                type="number" required
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-[#1e293b] p-5 rounded-xl border border-slate-200 dark:border-slate-700">
          ...
          <p className="text-2xl font-black mt-1">NPR {totalValue.toLocaleString()}</p>
        </div>
        <div className="bg-white dark:bg-[#1e293b] p-5 rounded-xl border border-slate-200 dark:border-slate-700">
                ...
                <tr key={item.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                  ...
                  <td className="p-4">
                    <div className="text-xs">
                      <p className="text-slate-400 line-through">NPR {item.buyPrice}</p>
                      <p className="font-bold text-slate-900 dark:text-white">NPR {item.sellPrice}</p>
                    </div>
                  </td>
