          ...
          <div className="lg:col-span-1 space-y-6">
             <div className="bg-white dark:bg-[#1e293b] rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
                ...
                <div className="flex items-center gap-3">
                    <img src={jobData.customer.avatar} className="w-10 h-10 rounded-full" alt="" />
                    <div>
             ...
             <div className="bg-white dark:bg-[#1e293b] rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
                ...
                <img src={jobData.vehicle.image} className="w-full h-32 object-cover rounded-lg mb-2" alt="" />
